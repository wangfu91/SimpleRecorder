...
namespace CaptureEncoder
{
    public sealed class Encoder : IDisposable
    {
        ...
        private unsafe void OnMediaStreamSourceSampleRequested(MediaStreamSource sender, MediaStreamSourceSampleRequestedEventArgs args)
        {
        ...
        private void OnMediaStreamSourceStarting(MediaStreamSource sender, MediaStreamSourceStartingEventArgs args)
        {
            ...
            {
                timeOffset += audioFrame.RelativeTime.GetValueOrDefault();
            }
        }
